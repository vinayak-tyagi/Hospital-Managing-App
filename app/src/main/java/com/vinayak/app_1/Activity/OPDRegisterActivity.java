...
public class OPDRegisterActivity extends AppCompatActivity {
    ...
    private static String UID = "KHRCOPD ";
    private static String TAG = OPDRegisterActivity.class.getSimpleName();

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_opd_registration);
        ...
        if(getSupportActionBar() != null){
            getSupportActionBar().setTitle("OPD Registration");
        ...
        register = findViewById(R.id.opd_register_btn);
        ...
        if (Utils.isNetworkAvailable()){
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Endpoints.REGISTER, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    pd.dismiss();
                    Utils.handleSimpleVolleyRequestError(error,OPDRegisterActivity.this);
                }
            }){
                @Override
